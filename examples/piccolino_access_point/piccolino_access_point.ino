/*
Creates an access point and waits for commands
*/

const char *MY_SSID="Piccolino WIFI";
...
void loop(void) {
  ...
  wifi.load("APpicoWIFI.lua");

  wifi.disconnect();  // disconnect just in case
  debug(F("Starting AP ...\n"));
  wifi.setIP("192.168.10.1","255.255.255.0","192.168.10.1");
